...
class Hijri_date_id
{
	private static $months = array(1=>'Muharram', 'Safar', "Rabi'ul Awal", "Rabi'ul akhir", 'Jamadil Awal', 'Jamadil Akhir', 'Rejab', "Sya'ban", 'Ramadhan', 'Syawal', 'Zulkaedah', 'Zulhijjah');
